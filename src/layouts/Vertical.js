...
class VerticalLayout extends Component {
    ...
    render() {
        ...
        const isCondensed = layoutConstants.LEFT_SIDEBAR_TYPE_FIXED === layoutConstants.LEFT_SIDEBAR_TYPE_CONDENSED;
        const isLight = layoutConstants.LEFT_SIDEBAR_THEME_DARK === layoutConstants.LEFT_SIDEBAR_THEME_DEFAULT;
...
export default connect(null, { changeSidebarType })(VerticalLayout);
